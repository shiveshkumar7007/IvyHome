...
import { getAllListings, addFavourite, removeFavourite, getFavourites } from "../api/ivyApi";
...
export default function MapExplorer() {
  ...
  useEffect(() => {
    ...
    filteredListings.forEach(item => {
      ...
      if (!isNaN(lat) && !isNaN(lng)) {
        ...
        marker.on('click', () => {
          // Reset previous active marker icon to blue
          if (activeMarkerRef && activeMarkerRef !== marker) {
            activeMarkerRef.setIcon(blueIcon);
          }
          // Set current marker icon to red
          marker.setIcon(redIcon);
          setActiveMarkerRef(marker);
  ...
  return (
    <div className="min-h-screen bg-white pb-12 font-sans flex flex-col relative overflow-hidden">
      ...
      {/* Left Sliding Sidebar Drawer for Listing Details */}
      <div className={`fixed inset-y-0 left-0 z-50 w-full sm:w-[440px] bg-white shadow-2xl border-r border-gray-200 transform transition-transform duration-300 ease-in-out flex flex-col ${selectedListing ? 'translate-x-0' : '-translate-x-full'}`}>
        {selectedListing && (
          <div className="flex flex-col h-full">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-extrabold uppercase px-2.5 py-1 bg-[#D97051] text-white rounded-lg">
                    {selectedListing.property_type || 'Apartment'}
                  </span>
                  <button 
                ...
                <h2 className="text-xl font-black text-[#1E2022] mt-2">{selectedListing.apartment_name || 'Property Detail'}</h2>
              </div>
              <button 
            ...
            {/* Sidebar Body with Rich Metadata */}
            <div className="p-6 flex-1 overflow-y-auto space-y-4">
              ...
              <div className="flex justify-between items-center bg-gray-50 p-4 rounded-2xl border border-gray-100">
                <div>
                  ...
                  <p className="text-xl font-black text-[#059669]">{formatPrice(selectedListing.price)}</p>
                </div>
              ...
              <div className="p-3 bg-[#FDF1EA]/50 rounded-2xl border border-[#D97051]/20 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-[10px] font-bold text-gray-400 uppercase">Owner / Contact</p>
            ...
            <div className="p-4 border-t border-gray-100 bg-white">
              <Link 
                to={`/listings/${selectedListing.listing_id || selectedListing.id}`}
