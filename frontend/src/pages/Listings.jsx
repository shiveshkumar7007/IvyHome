...
import { X, Bed, Maximize2, Heart, Phone, User, Compass, Building, Car, Layers } from "lucide-react";
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        ...
        {loading ? (
          ...
          <>
            ...
            <ListingCards listings={filteredListings} onCardClick={(item) => setSelectedListing(item)} />
          </>
        ) : (
